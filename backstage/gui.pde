...
public void createGUI(){
  ...
  controlPanel = new GPanel(cp, 88, 32, 488, 240, "Control Panel");
  ...
  textLabel = new GTextField(cp, 72, 48, 168, 16, G4P.SCROLLBARS_NONE);
  textLabel.setOpaque(true);
  labelLabel = new GLabel(cp, 8, 48, 64, 16);
  labelLabel.setText("Label");
  labelLabel.setOpaque(false);
  labelPath = new GLabel(cp, 8, 24, 64, 16);
  labelPath.setText("Path");
  labelPath.setOpaque(false);
  textPath = new GTextField(cp, 72, 24, 408, 16, G4P.SCROLLBARS_NONE);
  ...
  labelX = new GLabel(cp, 8, 72, 64, 16);
  labelX.setText("Left");
  labelX.setOpaque(false);
  labelY = new GLabel(cp, 8, 96, 64, 16);
  labelY.setText("Top");
  labelY.setOpaque(false);
  labelW = new GLabel(cp, 128, 72, 64, 16);
  labelW.setText("Width");
  labelW.setOpaque(false);
  labelH = new GLabel(cp, 128, 96, 64, 16);
  labelH.setText("Height");
  labelH.setOpaque(false);
  textX = new GTextField(cp, 72, 72, 48, 16, G4P.SCROLLBARS_NONE);
  textX.setOpaque(true);
  textY = new GTextField(cp, 72, 96, 48, 16, G4P.SCROLLBARS_NONE);
  textY.setOpaque(true);
  textW = new GTextField(cp, 192, 72, 48, 16, G4P.SCROLLBARS_NONE);
  textW.setOpaque(true);
  textH = new GTextField(cp, 192, 96, 48, 16, G4P.SCROLLBARS_NONE);
  ...
  labelTitle.setText("Backstage v.1.3");
